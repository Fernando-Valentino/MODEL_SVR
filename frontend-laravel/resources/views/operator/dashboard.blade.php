...
<div class="container-fluid p-0">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="card-title border-0 pb-0 mb-0">Grafik Tren Pendapatan Retribusi Parkir</h5>
                <a href="{{ route('operator.prediksi.index') }}" class="btn btn-outline-dark btn-sm"><i class="bi bi-cpu me-1"></i>Latih Model SVR</a>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="card-title border-0 pb-0 mb-0">Data Pendapatan Terkini</h5>
                <a href="{{ route('operator.pendapatan.index') }}" class="btn btn-dark btn-sm"><i class="bi bi-pencil-square me-1"></i>Kelola Pendapatan</a>
            </div>
