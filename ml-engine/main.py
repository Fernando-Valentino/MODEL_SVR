...
app = FastAPI(
    title="REVORA API",
    description="Revenue Estimation, Visualization, Optimization, Reporting, and Analytics - IMPLEMENTASI SUPPORT VECTOR REGRESSION DENGAN OPTIMASI GRID SEARCH DAN GREY WOLF OPTIMIZER UNTUK PREDIKSI PENDAPATAN RETRIBUSI PARKIR PADA DINAS PERHUBUNGAN KOTA CIREBON",
    version="1.0.0"
)
