...
# GWO settings for Micro GS Search Space
NUM_WOLVES    = 12
MAX_ITER      = 20
DIM           = 3
N_SPLITS_GWO  = 5
...
# Micro GS Search Space
# C: [40, 80] -> log10 = [1.602, 1.903]
# eps: [0.005, 0.02] -> log10 = [-2.301, -1.699]
# gam: [0.005, 0.02] -> log10 = [-2.301, -1.699]
LB = np.array([1.602,  -2.301,  -2.301])
UB = np.array([1.903,  -1.699,  -1.699])
...
print("GWO MICRO GS BEST PARAMETERS:")
print(f"  C: {best_C:.6f}")
